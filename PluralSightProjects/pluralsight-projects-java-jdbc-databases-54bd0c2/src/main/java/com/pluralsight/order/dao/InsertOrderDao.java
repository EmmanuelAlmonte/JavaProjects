...
public class InsertOrderDao {
    private String sqlOrder = "INSERT INTO orders " +
            ...
            "VALUES (?, ?, ?)";
    String sqlOrderDetail = "INSERT INTO order_details "
                ...
                if (result != null) {
                    if (!result.next()) {
                        ...
                        for (OrderDetailDto orderDetailDto : orderDto.getOrderDetail()) {
                            ...
                            try (PreparedStatement detailsPS = createOrderDetailPreparedStatement(con,
                                    orderDetailDto)) {
     ...
     * @throws SQLException In case of an error
     */
    private PreparedStatement createOrderDetailPreparedStatement(Connection con, OrderDetailDto orderDetailDto)
            throws SQLException {
